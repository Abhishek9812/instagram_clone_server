...
import { ICreatePost } from '../../models/post/post.model';
...
class UserControllerV1 extends BaseController {
    ...
    public async createPost(req: IFilteredRequest<ICreatePost>, res: Response, next: NextFunction) {
        try {
            const requestResult: any = await userServicesV1.createPost(req.body);
            res.status(200).send(requestResult);
        } catch (error: any) {
            return res.send(error);
        }
    ...
    public async likePost(req: IFilteredRequest<ICreatePost>, res: Response, next: NextFunction) {
        try {
            const requestResult: any = await userServicesV1.likePost(req.body);
            res.status(200).send(requestResult);
        } catch (error: any) {
            return res.send(error);
        }
    ...
    public async dislikePost(req: IFilteredRequest<ICreatePost>, res: Response, next: NextFunction) {
        try {
            const requestResult: any = await userServicesV1.dislikePost(req.body);
            res.status(200).send(requestResult);
        } catch (error: any) {
            return res.send(error);
        }
    ...
    public async getAllPosts(req: IFilteredRequest<ICreatePost>, res: Response, next: NextFunction) {
        try {
            const requestResult: any = await userServicesV1.getAllPosts(req.body);
            res.status(200).send(requestResult);
        } catch (error: any) {
            return res.send(error);
        }
