...
class MasterRouteV1 extends BaseRoutes {
    ...
    private _configure() {
        ...
        this.router.post("/createPost" ,middleware, (req: Request, res: Response, next: NextFunction) => {
            userControllerV1.createPost(req, res, next);
        });  
        
        
        this.router.post("/likePost" ,middleware, (req: Request, res: Response, next: NextFunction) => {
            userControllerV1.likePost(req, res, next);
        });  
        
        this.router.post("/dislikePost" ,middleware, (req: Request, res: Response, next: NextFunction) => {
            userControllerV1.dislikePost(req, res, next);
        });  
        
        this.router.get("/getAllPosts" ,middleware, (req: Request, res: Response, next: NextFunction) => {
            userControllerV1.getAllPosts(req, res, next);
        });  
